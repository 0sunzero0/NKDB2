...
class Boardbotkinu4Spider(scrapy.Spider):
    ...
    ####### 수정사항
    start_urls = ['http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=747&category=5&thisPage=1&searchField=&searchText=']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ####### 수정사항
        self.start_urls = 'http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=747&category=5&thisPage=1&searchField=&searchText='
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ####### 수정사항
            link = "http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=747&category=5&thisPage=" +  str(page_no) + "&searchField=title&searchText="
            print(link)
